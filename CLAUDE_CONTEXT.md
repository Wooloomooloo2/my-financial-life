...
**Last updated:** 2026-06-06 — session shipped visual baseline + paintEvent charts (ADR-026), Create Schedule From Transaction (ADR-027), Payee aliases round 1 (ADR-029 + ADR-012 amendment), Spending Over Time rollup levels (ADR-030), hierarchical category picker (ADR-031), Vehicle account type (ADR-032), Per-account summary screen (ADR-033 + 2026-06-06 amendment on period presets), summary polish + drill-down (ADR-034).
