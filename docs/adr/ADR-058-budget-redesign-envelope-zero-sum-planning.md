...
**Date:** 2026-06-12
**Status:** Accepted (umbrella). **R1 + R2 + R3 + R4a shipped 2026-06-12**; R4b (pay-down goals) is the remaining scoped round under this ADR.
...
- **R4 — Credit cards as a budget source + pay-down goals** (the principle-3 future features). Split into two passes after scoping with the owner.
  ...
  - **R4b — Pay-down goals** (a dedicated goal object: card + target/date → required monthly pay-down + progress). Own pass, own migration.
