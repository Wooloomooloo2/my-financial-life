...
CREATE TABLE account (
    ...
    name             TEXT NOT NULL,
    type             TEXT NOT NULL,          -- 'cash_std' | 'savings_std' | 'credit_std' | 'investment_std' | 'property_std'
    family           TEXT NOT NULL,          -- 'cash' | 'credit' | 'investment' | 'property' (derived from type, denormalised for fast filtering)
